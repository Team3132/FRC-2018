 ...
 */
public class DriveRoutineCheesyDpad implements DriveRoutine {
	...
	public DriveRoutineCheesyDpad(IntSupplier dPad, ContinuousRange throttle, ContinuousRange wheel, Switch isQuickTurn,
			Log log) {
		this.dPad = dPad;
